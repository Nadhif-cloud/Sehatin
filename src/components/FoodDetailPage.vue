<template>
  <div class="space-y-6 lg:space-y-8">
    ...
    >
      ...
      <button
        @click="goBack"
        class="mt-6 bg-slate-700 hover:bg-slate-800 text-white px-6 py-2.5 rounded-lg font-semibold text-sm transition-colors"
      >
        Kembali
      </button>
    </div>
    ...
    <div v-else-if="recipe" class="max-w-4xl mx-auto">
      ...
      <div class="mb-6">
        <button
          @click="goBack"
          class="cursor-pointer inline-flex items-center text-sm font-medium text-[rgba(0,119,137,1)] hover:text-[rgba(0,90,105,1)] transition-colors duration-200"
        >
        ...
        <div class="p-6 lg:p-8">
          ...
          >
            <div>
              ...
              >
              <h1 class="text-3xl lg:text-4xl font-bold text-gray-900 mt-3">
                {{ recipe.name }}
              </h1>
            </div>
            <button
              @click.stop.prevent="toggleFavorite(recipe)"
              class="cursor-pointer flex items-center space-x-2 px-4 py-2.5 rounded-lg transition-all duration-200 border w-full sm:w-auto"
              :class="
                recipe.is_favorited
            ...
            >
              <Heart
                ...
                :class="{
                  'text-red-500': recipe.is_favorited,
                  'text-gray-400': !recipe.is_favorited,
                }"
              />
              <span class="font-semibold text-sm">{{
                recipe.is_favorited ? "Favorit" : "Tambahkan ke Favorit"
              }}</span>
            </button>
          </div>
          ...
          <!-- Info Cepat -->
          <div
            class="flex flex-wrap gap-x-6 gap-y-2 text-gray-600 border-y py-4 mb-6"
          >
            <div
          ...
          <div class="grid md:grid-cols-12 gap-8 lg:gap-10">
            <div class="md:col-span-4">
              ...
              <ul
                ...
                class="list-disc list-inside space-y-2 text-gray-700 pl-1"
              >
                <li
            ...
            <div class="md:col-span-8">
              ...
              <ol
                ...
                class="list-decimal list-inside space-y-4 text-gray-700 pl-1"
              >
                <li
