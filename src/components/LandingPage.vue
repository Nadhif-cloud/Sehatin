<template>
  ...
  >
    ...
    >
      ...
      <!-- Floating elements -->
      <div class="absolute top-20 left-10 w-6 h-6 bg-[rgba(127,220,214,0.3)] rounded-full blur-sm animate-float-slow"></div>
      <div class="absolute top-40 right-20 w-8 h-8 bg-[rgba(0,119,137,0.2)] rounded-full blur-sm animate-float-medium"></div>
      <div class="absolute bottom-32 left-20 w-5 h-5 bg-[rgba(127,220,214,0.4)] rounded-full blur-sm animate-float-fast"></div>
      
      <div
        class="relative z-10 p-6 max-w-4xl lg:max-w-6xl"
      >
        <div class="mb-8">
          <h1
    ...
    <div 
      ...
      :class="showExploreOverlay ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'"
    >
      <button
    ...
    >
      ...
      <div class="absolute top-0 left-0 w-72 h-72 bg-[rgba(0,119,137,0.03)] rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
      <div class="absolute bottom-0 right-0 w-96 h-96 bg-[rgba(127,220,214,0.03)] rounded-full blur-3xl translate-x-1/2 translate-y-1/2"></div>
      ...
      <div class="container mx-auto px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        >
          <h2 class="text-4xl lg:text-5xl font-semibold text-gray-900 tracking-tight mb-6">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          >
            ...
            <div class="absolute inset-0 bg-gradient-to-br from-[rgba(0,119,137,0.02)] to-[rgba(127,220,214,0.02)] rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            ...
            <div class="relative z-10">
              ...
              <h3 class="text-2xl lg:text-3xl font-medium mb-4 text-gray-900 tracking-tight group-hover:text-[rgba(0,119,137,1)] transition-colors duration-300">
                {{ feature.title }}
              </h3>
              
              <p class="text-gray-600 text-base leading-relaxed flex-grow font-light group-hover:text-gray-700 transition-colors duration-300">
                {{ feature.description }}
              </p>
    ...
    <section id="resep" class="py-24 lg:py-32 bg-gray-50/50 relative overflow-hidden">
      <!-- Animated background elements -->
      <div class="absolute top-10 right-10 w-20 h-20 bg-[rgba(0,119,137,0.05)] rounded-full animate-pulse-slow"></div>
      <div class="absolute bottom-20 left-10 w-16 h-16 bg-[rgba(127,220,214,0.05)] rounded-full animate-pulse-medium"></div>
      ...
      <div class="container mx-auto px-6 lg:px-8 max-w-7xl">
        ...
        <div class="grid lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div
            v-if="foods.length > 0"
            class="lg:col-span-8 group relative bg-white rounded-3xl shadow-lg overflow-hidden transition-all duration-700 animate-on-scroll hover:shadow-2xl hover:scale-[1.02]"
            data-animation="fade-in-right"
          >
            <div class="md:flex h-full">
              <div class="md:w-1/2 lg:w-3/5 overflow-hidden h-72 md:h-full relative">
                <img
                  :src="foods[0].image"
              ...
              <div
                class="p-8 lg:p-10 flex flex-col justify-center md:w-1/2 lg:w-2/5 relative z-10"
              >
                <span
                  class="text-sm font-medium text-[rgba(0,119,137,1)] uppercase tracking-wider mb-3 inline-block"
                >
                  Resep Unggulan
                </span>
                
                <h3
                  class="text-3xl lg:text-4xl font-medium mb-4 text-gray-900 tracking-tight group-hover:text-[rgba(0,119,137,1)] transition-colors duration-300"
                >
                  {{ foods[0].name }}
                </h3>
                
                <p
                  class="text-gray-600 text-base mb-8 leading-relaxed line-clamp-3 font-light"
                >
                  {{ foods[0].description }}
                </p>
                ...
                <button
                  ...
                  class="group/btn inline-flex items-center text-base font-medium text-white bg-[rgba(0,119,137,1)] hover:bg-[rgba(0,90,105,1)] py-3 px-6 rounded-xl transition-all duration-300 self-start hover:shadow-lg hover:scale-105"
                >
                  <span class="mr-2">Lihat Detail</span>
                  <ArrowRight class="w-4 h-4 transform group-hover/btn:translate-x-1 transition-transform duration-300" />
                </button>
              </div>
            </div>
          </div>
          ...
          <!-- Food Cards Grid -->
          <div class="lg:col-span-4 grid gap-8 lg:gap-10">
            <div
              v-for="(food, index) in foods.slice(1, 3)"
              :key="food.name"
              class="group relative bg-white rounded-3xl shadow-lg overflow-hidden transition-all duration-500 animate-on-scroll hover:shadow-xl hover:scale-105"
            ...
            >
              ...
              <div class="p-6 lg:p-7 relative z-10">
                <h3 class="text-xl font-medium mb-3 text-gray-900 line-clamp-2 tracking-tight group-hover:text-[rgba(0,119,137,1)] transition-colors duration-300">
                  {{ food.name }}
                </h3>
                
                <p
                  class="text-gray-600 text-sm mb-5 leading-relaxed line-clamp-2 font-light"
                >
                  {{ food.description }}
                </p>
                ...
                <button
                  @click="handleNavigation('/dashboard/makanan')"
                  class="group/link inline-flex items-center text-sm font-medium text-[rgba(0,119,137,1)] hover:text-[rgba(0,90,105,1)] transition-all duration-300"
                >
                  <span class="mr-1">Selengkapnya</span>
                  <ArrowRight class="w-4 h-4 transform group-hover/link:translate-x-1 transition-transform duration-300" />
                </button>
              </div>
            </div>
          </div>
    ...
    <section id="latihan" class="py-24 lg:py-32 bg-white relative">
      ...
      <div class="absolute inset-0 opacity-5 bg-[length:100px_100px] bg-repeat exercise-pattern">
      </div>
      ...
      <div class="container mx-auto px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
          ...
          >
            ...
            <!-- Hover effect border -->
            <div class="absolute inset-0 border-2 border-transparent rounded-3xl group-hover:border-[rgba(0,119,137,0.1)] transition-all duration-500"></div>
          </div>
        </div>
      </div>
    </section>
    ...
    >
      ...
      <div class="container mx-auto px-6 lg:px-8 max-w-4xl relative z-10">
        ...
        <p
          ...
          data-delay="150"
        >
          Bergabunglah dengan Sehatin hari ini dan dapatkan akses penuh ke
        ...
        >
          ...
          >
            ...
            <div class="absolute inset-0 bg-gradient-to-r from-transparent via-[rgba(0,119,137,0.1)] to-transparent -skew-x-12 transform translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></div>
          </button>
        </div>
      </div>
    </section>
    ...
    <footer class="bg-gray-900 text-gray-400 py-20 text-center sm:text-left relative overflow-hidden">
      <!-- Background pattern - menggunakan CSS class sederhana -->
      <div class="absolute inset-0 opacity-5 bg-[length:200px_200px] bg-repeat footer-pattern">
      </div>
      ...
      <div class="container mx-auto px-6 lg:px-8 max-w-6xl relative z-10">
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div class="animate-on-scroll" data-animation="fade-in-up">
            <h4 class="text-2xl font-medium text-white mb-6 tracking-tight">Sehatin</h4>
          ...
          <div class="animate-on-scroll" data-animation="fade-in-up" data-delay="100">
            <h5 class="text-xl font-medium text-white mb-6 tracking-tight">Navigasi</h5>
            <ul class="space-y-3">
          ...
          <div class="animate-on-scroll" data-animation="fade-in-up" data-delay="200">
            <h5 class="text-xl font-medium text-white mb-6 tracking-tight">Legal</h5>
            <ul class="space-y-3">
          ...
          <!-- Sosial Media -->
          <div class="animate-on-scroll" data-animation="fade-in-up" data-delay="300">
            <h5 class="text-xl font-medium text-white mb-6 tracking-tight">Ikuti Kami</h5>
        ...
        <!-- Copyright -->
        <hr class="my-14 border-gray-800 animate-on-scroll" data-animation="fade-in-up" />
        <p class="text-sm text-gray-500 text-center font-light animate-on-scroll" data-animation="fade-in-up">
...
// --- Data untuk Footer ---
const footerNav = ref([
  { name: "Fitur", action: () => scrollToSection('#features-teaser') },
  { name: "Resep", action: () => scrollToSection('#food-section') },
  { name: "Latihan", action: () => scrollToSection('#exercise-section') },
...
const teaserFeatures = ref([
  {
    ...
    description: "Ketahui status gizi dan kebugaran Anda dengan alat analisis komprehensif kami.",
    icon: LineChart,
  },
  {
    title: "Rencana Nutrisi Cerdas",
    description: "Dapatkan rekomendasi menu harian yang disesuaikan dengan kebutuhan kalori dan target kesehatan Anda.",
    icon: Apple,
  },
  {
    title: "Program Latihan Dinamis",
    description: "Akses beragam program latihan interaktif, dari pemula hingga mahir, dengan panduan video.",
    icon: Dumbbell,
  },
]);
...
const foods = ref([
  {
    ...
    description: "Energi pagi dengan smoothie bowl kaya antioksidan, topping granola, biji chia, dan irisan buah segar.",
    image: "https://images.unsplash.com/photo-1507120366498-4656eaece7fa?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fGp1aWNlfGVufDB8fDB8fHww",
  },
  {
    name: "Salmon Panggang Asparagus Lemon",
    description: "Hidangan utama lezat kaya protein dan omega-3, salmon fillet dipanggang dengan asparagus segar dan saus lemon dill.",
    image: "https://images.unsplash.com/photo-1467003909585-2f8a72700288?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80&h=1000",
  },
  {
    name: "Salad Chickpea & Alpukat Segar",
    description: "Salad ringan namun mengenyangkan, paduan chickpea, alpukat, tomat ceri, dan dressing madu mustard.",
    image: "https://images.unsplash.com/photo-1540420773420-3366772f4999?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80&h=1000",
  },
]);
...
const exercises = ref([
  {
    ...
    description: "Awali hari dengan sesi yoga vinyasa untuk meningkatkan fleksibilitas, keseimbangan, dan ketenangan pikiran.",
    image: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80&h=1080",
    linkText: "Mulai Yoga",
  },
  {
    name: "Latihan Kekuatan Tubuh Bagian Atas",
    description: "Program 30 menit untuk memperkuat otot dada, punggung, dan lengan dengan dumbbell dan resistance band.",
    image: "https://images.unsplash.com/photo-1674834726923-3ba828d37846?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8TGF0aWhhbiUyMEtla3VhdGFuJTIwVHVidWglMjBCYWdpYW4lMjBBdGFzfGVufDB8fDB8fHww",
    linkText: "Coba Latihan",
  },
  {
    name: "Latihan Kardio HIIT 20 Menit",
    description: "Sesi HIIT singkat namun intens untuk membakar kalori maksimal dan meningkatkan daya tahan jantung.",
    image: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80&h=1080",
    linkText: "Coba HIIT",
  },
]);
