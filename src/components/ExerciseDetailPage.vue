          ...
          >
            <div>
              <span
                ...
                :class="getCategoryClass(exercise.category)"
            ...
            <button
              @click.stop.prevent="toggleFavorite(exercise)"
            ...
            >
              <Heart
                :size="20"
                :fill="exercise.is_favorited ? 'currentColor' : 'none'"
                :class="{
                  'text-red-500': exercise.is_favorited,
                  'text-gray-400': !exercise.is_favorited,
                }"
              />
              <span class="font-semibold text-sm">{{
                exercise.is_favorited ? "Favorit" : "Tambahkan ke Favorit"
              }}</span>
            </button>
          </div>
